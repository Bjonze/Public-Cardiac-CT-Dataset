...
**The left atrial appendage (LAA)** is a small finger-like extension on the left atrium. It is suspected that a significant amount of blood clot-related strokes originate in the LAA, and that the shape of the LAA is one of several factors influencing the risk of stroke. The variation in LAA morphology across a population is considerable, and there is ongoing research focused on characterizing and classifying these shapes.
